...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--itr_count', type=int, default=0, help='the starting itr count, we save the model')
        ...
        self.parser.add_argument('--lambda_flow', type=float, default=0.01, help='')
        ...
        self.parser.add_argument('--iterations_limit', type=int, default=1000, help='the number of iteration of training')
        self.parser.add_argument('--stage', help='the stage of training')

        self.parser.add_argument('--ofe_ckpt', help="restore checkpoint of Optical Flow Estimator")
        self.parser.add_argument('--position_only', default=False, action='store_true',
                        help='only use position-wise attention')
        self.parser.add_argument('--position_and_content', default=False, action='store_true',
                            help='use position and content-wise attention')
        self.parser.add_argument('--num_heads', default=1, type=int,
